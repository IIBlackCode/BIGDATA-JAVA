...
public class deptView extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, 
		...
		try {
			...
			rs.close();
			pw.println("</table>");	
			pw.println("<a href='20201112deptUpdate?DEPT_ID=" + dept_id + "'>수정</a>");
			pw.println("<a href='20201112deptDelete?DEPT_ID=" + dept_id + "'>삭제</a>");
			pw.println("<a href='20201112deptList'>목록</a>");
