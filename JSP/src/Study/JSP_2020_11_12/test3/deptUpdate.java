...
@WebServlet("/20201112deptUpdate")
public class deptUpdate extends HttpServlet {
	protected void doGet(HttpServletRequest request, 
			HttpServletResponse response) throws ServletException, IOException {
		System.out.println("SELECT * FROM dept WHERE dept_id = "+request.getParameter("DEPT_ID"));
		try {
			...
			pw.println("<form action=20201112deptUpdateProcess method=post>");
