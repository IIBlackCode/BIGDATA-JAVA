<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="Study.JSP_2020_11_16.Student" %>
...
%>
<jsp:useBean id="s2" class="Study.JSP_2020_11_16.Student"></jsp:useBean>
<%
	s2.setName("jane");
...
<br>
<jsp:useBean id="s3" class="Study.JSP_2020_11_16.Student"></jsp:useBean>
